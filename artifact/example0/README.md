...
```bash
bash example0/QuantumNas/1_train_supercircuit.sh
```

## Evolutionary search
```bash
bash example0/QuantumNas/2_search.sh
```

## Train the searched sub circuit from scratch
```bash
bash example0/QuantumNas/3_train_subcircuit.sh
```

## Iterative pruning
```bash
bash example0/QuantumNas/4_prune.sh
```

## Evaluate on real QC
```bash
bash example0/QuantumNas/5_eval.sh
```
...
## Train
```bash
bash example0/human/1_train.sh
```

## Eval
```bash
bash example0/human/2_eval.sh
```