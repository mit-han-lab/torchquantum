...
def get_named_sample_arch(arch_space, name):
    ...
    if name == 'smallest':
        ...
        arch_dict = {
            ...
            'blk3_rand3': [[1, 2], [[2, 3]], [0, 1, 2], [[0, 1], [2, 3]], [2], [[3, 0]], [1, 3], [[0, 1], [1, 2], [3, 0]], [0, 2], [[1, 2], [3, 0]], [0, 1], [[1, 2]], [2], [[0, 1], [1, 2], [3, 0]], [0, 1], [[0, 1], [2, 3], [3, 0]], 3],
            ...
            'blk5_rand3': [[1, 3], [[1, 2], [2, 3], [3, 0]], [0, 1, 3], [[1, 2], [3, 0]], [0, 1], [[2, 3]], [0, 1], [[1, 2], [3, 0]], [2], [[1, 2]], [2, 3], [[0, 1], [1, 2], [2, 3]], [0, 1, 2], [[0, 1], [1, 2]], [0, 3], [[0, 1], [1, 2], [2, 3], [3, 0]], 5],
            ...
            'blk6_rand3': [[0, 3], [[3, 0]], [1], [[3, 0]], [0, 2], [[0, 1]], [2, 3], [[0, 1]], [3], [[1, 2], [2, 3], [3, 0]], [1], [[0, 1], [1, 2]], [0, 1, 2], [[1, 2], [3, 0]], [0, 2, 3], [[1, 2], [3, 0]], 6],
            ...
            'blk8_rand3': [[0, 3], [[1, 2], [3, 0]], [0, 1, 2, 3], [[0, 1], [3, 0]], [0, 1, 2], [[0, 1], [2, 3], [3, 0]], [1, 3], [[1, 2]], [1, 3], [[0, 1], [1, 2], [2, 3]], [3], [[0, 1]], [3], [[0, 1], [1, 2]], [0, 1, 3], [[2, 3]], 8],
        }
