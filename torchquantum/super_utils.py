...
def get_named_sample_arch(arch_space, name):
    ...
    if name == 'smallest':
        ...
        if configs.model.arch.q_layer_name in ['u3cu3_s0', 'seth_s0', 'farhi_s0']:
            arch_dict = {
                ...
                'blk1_rand4': [4, 3, 2, 1, 1, 2, 4, 2, 4, 2, 3, 4, 3, 1, 2, 1, 1],
                ...
                'blk5_rand4': [2, 1, 4, 2, 2, 1, 1, 3, 4, 4, 3, 4, 4, 4, 4, 4, 5],
                ...
                'blk6_rand5': [2, 3, 2, 2, 3, 2, 3, 2, 3, 1, 4, 3, 3, 4, 3, 3, 6],
                ...
                'blk7_rand5': [1, 3, 3, 3, 3, 4, 1, 4, 4, 3, 2, 2, 4, 4, 3, 4, 7],
