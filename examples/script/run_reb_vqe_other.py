...
if __name__ == '__main__':
    ...
    with open(f'logs/reb/vqe.step1000.{setting}.{args.dataset}.{args.name}.'
        ...
        for k, space in enumerate([
            ...
            exp = f'runs/{args.dataset}.step1000.{args.name}.train.searched.scratch' \
                  f'.{args.device}.{noise_setting}.opt2.setting0.{space}.{mode}/'
