...
if __name__ == '__main__':
    ...
    with open(f'logs/reb/vqe.step1000.prune.{setting}.{args.dataset}.{args.name}'
        ...
        for k, space in enumerate([
            ...
            pres = ['python',
                    ...
                    f'{args.device}/real/opt2/pruned/all.yml',
                    '--jobs=1',
                    f'--hub={args.hub}',
                    '--run-dir']

            exp = f'runs/{args.dataset}.step1000.{args.name}.prune.searched' \
                  f'.{args.device}.noise.opt2.setting0.pr0.5.{space}.{mode}/'
