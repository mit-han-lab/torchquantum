...
def main() -> None:
    ...
    processor_list = []
    processor = QiskitProcessor(use_real_qc=configs.qiskit.use_real_qc, n_shots=1024, backend_name=configs.qiskit.backend_name)
    processor_list.append((1024, processor))
    trainer.set_processor_list(processor_list)
    ...
    print(args.run_dir)
    import json
    with open(args.run_dir+'/data.txt', 'w') as f:
        json.dump(record, f)
