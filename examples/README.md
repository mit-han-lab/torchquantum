...
- [Simple QNN for MNIST](simple_mnist)
- [Quantum Convolution (Quanvolution)](quanvolution)
- [Quantum Kernel Method](quantum_kernel_method)
- [Quantum on-chip training with parameter shift](param_shift_onchip_training)
- [Clifford QNN](clifford_qnn)
