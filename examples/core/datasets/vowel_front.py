    ...
    def load(self):
        ...
        if self.split == 'train' or self.split == 'valid':
            ...
            for number in self.digits_of_interest:
                ...
                data_list.append(torch.mean(train_valid.data[idx][:fold * num_samples_one_class, :].view(fold, num_samples_one_class, 10).float(), dim=0).to(dtype=torch.uint8))
